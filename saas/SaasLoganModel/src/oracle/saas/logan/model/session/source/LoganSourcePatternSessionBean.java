...
public class LoganSourcePatternSessionBean implements LoganSourcePatternSession, LoganSourcePatternSessionLocal {
    ...
    @TransactionAttribute(TransactionAttributeType.NOT_SUPPORTED)
    public List<EmLoganSourcePattern1> getEmLoganSourcePatternFindAllBySourceId( Integer sourceId) {
        return em.createNamedQuery("EmLoganSourcePattern1.findAllPatternsBySourceId",
                                   EmLoganSourcePattern1.class).setParameter("sourceId",sourceId).getResultList();
    }
    ...
    public List<Object[]> getEmLoganSourcePatternFindAllBySourceId(Integer isIncl, Integer sourceId) {
        return em.createNamedQuery("EmLoganSourcePattern1.findAllBySourceId",
                                   Object[].class).setParameter("isIncl", isIncl).setParameter("sourceId",
